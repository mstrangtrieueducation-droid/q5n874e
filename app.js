(() => {
  ...
  function renderLesson() {
    ...
    $("#lessonVisual").src = `assets/images/${lesson.image}.webp?v=20260806-discover2-hires-dtw-u1`;
  ...
  function cueNode(cue) {
    if (typeof cue === "object" && cue.image) {
      ...
      image.src = `assets/images/${cue.image}.webp?v=20260806-discover2-hires-dtw-u1`;
      image.alt = "";
  ...
  function renderPrompt() {
    ...
    $("#practiceVisual").src = `assets/images/${prompt.image}.webp?v=20260806-discover2-hires-dtw-u1`;
